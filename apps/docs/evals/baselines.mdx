...
The cell key includes the case, its source, preparation and validator, and the variant: harness, model, and sandbox. Changing any of them starts a new history.
...
The shared prompt is not part of the key. This keeps prompt changes comparable against the same case and runtime.

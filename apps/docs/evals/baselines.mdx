...
The cell key includes the case task, source, setup, verifier, harness, harness version, model, and sandbox provider. Changing any of them starts a new history.

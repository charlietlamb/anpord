...
Attach mocks on the suite, then check the call logs in a validator. [API mocks](/evals/api-mocks) work the same way.
...
export default suite({
  ...
  mcp: [usersMcp],
  cli: [usersCli],
  cases: [{ id: "gets-user", name: "gets user", validate }],

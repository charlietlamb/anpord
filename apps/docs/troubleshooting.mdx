...
Model catalogues come from Anpord's Codex cache, models.dev, or a fixed list, depending on the harness. An empty result means that source is unavailable or empty.

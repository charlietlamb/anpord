...
`import.meta.url` tells Anpord where the eval was written, which is how the validators reach the sandbox with everything they close over. `start` and `startAndWait` compile it for you.

...
export const fieldVariants = cva(
  `skeleton:skeleton-block ${FIELD_SURFACE} w-full min-w-0 px-3 text-sm placeholder:font-medium placeholder:text-muted-foreground/70 disabled:pointer-events-none disabled:opacity-50`,
  {
